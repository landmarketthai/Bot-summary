...
const FRUIT_PREFIXES = [
  ...
  "ลองกอง", "ลำไย", "ลูก", "ส้ม", "สละ", "สับปะรด", "สาลี่", "องุ่น",
  "อะโวคาโด", "อินทผลัม", "แอปเปิ้ล", "เมล่อน", "ไซมัส",
];

const VEGETABLE_PREFIXES = [
  "กระชาย", "กระเทียม", "กะเพรา", "กะหล่ำ", "กวางตุ้ง", "ขมิ้น", "ข้าวโพดอ่อน",
  "ขิง", "คะน้า", "แครอท", "ชะอม", "ดอก", "ต้นหอม", "ตำลึง", "แตงกวา", "แตงร้าน",
  "แตงล้าน", "ถั่ว", "น้ำเต้า", "บวบ", "บรอกโคลี", "ผัก", "ฟัก", "มะเขือ", "มะระ",
  "มันฝรั่ง", "ยอด", "สายบัว", "หน่อไม้", "หอม", "หัวไชเท้า", "หัวปลี", "ใบ", "พริก",
];
